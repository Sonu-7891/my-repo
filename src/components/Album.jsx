  ...
  return (
    ...
    <div className='mt-10 flex gap-8 flex-col md:flex-row md:items-end'>
        ...
        <div className='flex flex-col'>
            ...
            <p className='mt-1'>
                <img className='inline-block w-7 mr-2' src={assets.spotify_logo} alt="" />
                <b className='mr-2'>Spotify</b>
                {/* <span className= ' font-extrabold' >&#183;</span>1,372,382 likes */}
                <b className='mr-2'> <span className= ' font-extrabold' >&#183;</span> 50 Songs,</b>
                about 2 hr
            </p>
        </div>
    </div>
    ...
    <div className='grid grid-cols-4 sm:grid-col-4 mt-10 mb-4 pl-2 text-[#a7a7a7] '>
      <p className='mr-8'><b className='mr-2'>#</b>Title</p>
    ...
    <hr />
    {
      songsData.map((item,index) => (
        <div onClick={()=>playWithId(item.id)} key={index} className='grid grid-cols-4 sm:grid-col-4 gap-2 p-2 items-center text-[#a7a7a7] hover:bg-[#ffffff2b] cursor-pointer'>
